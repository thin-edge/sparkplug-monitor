...
# Custom broker
./spmonitor --broker 192.168.1.10:1883

# Sparkplug B group / edge node (must match your flow.toml config)
./spmonitor --group tedge --node gateway01

# Extra topics
./spmonitor --topics "my/custom/topic,another/topic"
```
